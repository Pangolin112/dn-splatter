...
class DNTrainer(Trainer):
    ...
    def save_checkpoint(self, step: int) -> None:
        ...
        pipeline_state_dict = {k: v for k, v in self.pipeline.state_dict().items() if not (k.startswith("lseg_model.") or k.startswith("ip2p_ptd.") or k.startswith("ip2p_depth.") or k.startswith("MODEL.") or k.startswith("CONDITIONER.") or k.startswith("AE.") or k.startswith("DENOISER."))}
