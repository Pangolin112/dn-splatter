...
dn_splatter = MethodSpecification(
    ...
    config=DNTrainerConfig(
        ...
        steps_per_save=2500, #500, #1000000,
        steps_per_eval_all_images=1000000,
        max_num_iterations=7500, #7500, # 30000 for the 1st stage, 7500 for the 2nd stage
...
ags_mesh = MethodSpecification(
    config=TrainerConfig(
        method_name="ags-mesh",
        steps_per_eval_image=500,
        steps_per_eval_batch=500,
        steps_per_save=1000000,
        steps_per_eval_all_images=1000000,
        max_num_iterations=7500, #30000,
        mixed_precision=False,
        gradient_accumulation_steps={"camera_opt": 100, "color": 10, "shs": 10},
        pipeline=DNSplatterPipelineConfig(
            datamanager=DNSplatterManagerConfig(
    ...
    description="AGS-Mesh variant of Splatfacto model. Incorporates depth and normal filtering strategy.",
)
