        ...
        if (not self.makeSquentialEdits):
            ...
            if step % self.config_secret.edit_rate == 0:
                ...
                if step % 50 == 0:
                    ...
                    save_image((image_save_non_secret).clamp(0, 1), image_dir / f'{step}_non_secret_image_{self.config_secret.image_guidance_scale_ip2p_ptd}_edit_rate_{self.config_secret.edit_rate}.png')
